...
function HeaderLinks(){
    ...
    return '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
              ...
              <style>
                  ...
                  button.dt-button.buttons-excel.buttons-html5.excel-btn {
                      color: #0e842f;
                      background: transparent;
                      border: none;
                      font-size: 17px;
                  }
                  button.dt-button.buttons-pdf.buttons-html5.pdf-btn {
                      color: #ea0606;
                      background: transparent;
                      border: none;
                      font-size: 17px;
...
function SideMenuBars(){
        ...
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"> 
              <a class="sidebar-link sidebar-title" href="#">
                <i class="color-white fa fa-shopping-cart " data-feather="shopping-cart "></i>
              <span>Products Qty</span></a>
              <ul class="sidebar-submenu">
              <li><a href="'.url('add-products-qty').'">Add Product qty</a></li>
              <li><a href="'.url('products-qty').'">Product qty list</a></li></ul>
            </li>
            ...
            <li class="sidebar-list"> 
              <a class="sidebar-link sidebar-title" href="#">
                <i class="color-white fa fa-shopping-cart " data-feather="shopping-cart "></i>
              <span>Return Products</span></a>
              <ul class="sidebar-submenu">
              <li><a href="'.url('add-return-product').'">Add Return products</a></li>
              <li><a href="'.url('return-product-list').'">Return products list</a></li></ul>
            </li>
            ...
            <li class="sidebar-list"> 
              <a class="sidebar-link sidebar-title" href="#">
                <i class="color-white fa fa-users" data-feather="shopping-cart "></i>
              <span>Assign Trainers</span></a>
              <ul class="sidebar-submenu">
              <li><a href="'.url('add-assigned-trainers').'">Assign Trainers</a></li>
              <li><a href="'.url('assigned-trainers').'">Assigned Trainers List</a></li></ul>
            </li>
            
            <li class="sidebar-list">
                <a class="sidebar-link sidebar-title link-nav active" href="'.url('leave-requests').'">
                    <i class="color-white fa fa-home " data-feather="shopping-cart "></i><span>Leave Requests</span>
                </a>
            </li>
      ...
      <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack" style="position: fixed;"></i>
              <a  class="sidebar-link sidebar-title link-nav active" href="dashboard"style="margin-top: 11px;" >
                
                <i class="color-white fa fa-home " data-feather="shopping-cart "></i><span>Packing Dashboard</span></a></li>
            </li>
            <li class="sidebar-list">
   ...
   <div class="sidebar-wrapper" data-layout="stroke-svg">
          ...
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack" style="position: fixed;"></i>
              <a  class="sidebar-link sidebar-title link-nav active" href="dashboard"style="margin-top: 11px;" >
                ...
                <i class="color-white fa fa-home " data-feather="shopping-cart "></i><span>Verifier Dashboard</span></a></li>
            </li>
            <li class="sidebar-list">
    ...
    $trainerAdmin = '<!-- Page Sidebar Start-->
   <div class="sidebar-wrapper" data-layout="stroke-svg">
      <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="'.asset('assets/images/logo/logo.png').'" alt=""></a>
        <div class="back-btn"><i class="fa fa-angle-left"> </i></div>
        <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
      ...
      <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list ">
              <a class="sidebar-link sidebar-title link-nav active" href="'.url('trainer_pending').'">
                
               <span>Pending </span></a>
            </li>
            <li class="sidebar-list">
              <a class="sidebar-link sidebar-title link-nav active" href="'.url('trainer_process').'">

             <span>Process</span></a>
            </li>

            <li class="sidebar-list">
              <a class="sidebar-link sidebar-title link-nav active" href="'.url('trainer_completed').'">
                
                <span>Completed</span></a>
            </li>
            <li class="sidebar-list">
              <a class="sidebar-link sidebar-title link-nav active" href="'.url('trainer_cancel_works').'">
                
                <span>Cancel Works</span></a>
            </li>
    ...
    }elseif(session('user')->user_type == 'Trainer'){
        return $trainerAdmin;
    }else{
...
function TextOfAmount($amount){
    $whole_part = floor($amount);
    $decimal_part = round(($amount - $whole_part) * 100);
    
    $amount_in_words = numberToWordsInRupees($whole_part) . ' Rupees';
    if ($decimal_part > 0) {
        $amount_in_words .= ' and ' . numberToWordsInRupees($decimal_part) . ' Paise';
    }
...
function numberToWordsInRupees($number) {
    $units = array(
    ...
    if ($number < 0) {
        return 'Minus ' . numberToWordsInRupees(abs($number));
    }
    ...
    if ($number < 100) {
        $unit = $number % 10;
        return $tens[$number - $unit] . ($unit ? ' ' . $units[$unit] : '');
    }

    if ($number < 1000) {
        $hundred = floor($number / 100);
        $remainder = $number % 100;
        return $units[$hundred] . ' Hundred' . ($remainder ? ' and ' . numberToWordsInRupees($remainder) : '');
    }

    if ($number < 100000) {
        $thousand = floor($number / 1000);
        $remainder = $number % 1000;
        return numberToWordsInRupees($thousand) . ' Thousand' . ($remainder ? ' ' . numberToWordsInRupees($remainder) : '');
    }

    if ($number < 10000000) {
        $lakh = floor($number / 100000);
        $remainder = $number % 100000;
        return numberToWordsInRupees($lakh) . ' Lakh' . ($remainder ? ' ' . numberToWordsInRupees($remainder) : '');
    }

    if ($number < 1000000000) {
        $crore = floor($number / 10000000);
        $remainder = $number % 10000000;
        return numberToWordsInRupees($crore) . ' Crore' . ($remainder ? ' ' . numberToWordsInRupees($remainder) : '');
    }

    return 'Number too large';
}

function PushNotification($title, $message, $type, $sendIds){
    $filteredIds = array_filter($sendIds, function($value) {
        return !is_null($value);
    });
    $sendIds = array_values($filteredIds);
    $serviceAccountPath = storage_path('app/fefdy-marketing-firebase-adminsdk-wzxwe-21f99a5ae1.json');

    $factory = (new Factory)->withServiceAccount($serviceAccountPath);

    $messaging = $factory->createMessaging();
    
    $notification = Notification::create($title, $message, $type);
    // dd($notification);
    $messages = collect($sendIds)->map(function($token) use ($notification, $title, $message, $type) {
    ...
    try {
        ...
        return response()->json([
            ...
            'code' => $e->getCode(),
            'response' => $e->getResponse()->getBody()->getContents() ?? 'No additional response body'
        ], 500);
    }
}