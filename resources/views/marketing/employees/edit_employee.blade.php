...
.col-md-4.position-relative.profile {
    display: flex;
    position: relative;
}
...
label.form-label.employee-profile-edit {
    position: absolute;
    text-align: center;
    /* margin: 10px; */
    padding-left: 42px;
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation custom-input" id="edit_employee_form" novalidate="" method="post">
                                    @csrf
                        ...
                        <div class="m-0 dz-message needsclick dropzone" id="singleFileUpload" action="/upload.php">
                          ...
                          <h6 class="mb-0">Drop files here or click to upload.</h6>
                                    ...
                                    <div class="col-xl-12 col-md-6 box-col-none">
                                        <div class="row ">
                                            <div class="col-md-4 position-relative profile">
                                            <label class="form-label employee-profile-edit" for="employee_profile"> Profile Image Upload* </label>
                                                ...
                                                @if ($employee->employee_profile)
                                                    <div class="profile-image">
                                                        <img class="profile-new" src="{{ asset($employee->employee_profile) }}" alt="Profile Image" style="max-width: 25%;height: 100%;">
                                                    </div>
                                                @else
                                            ...
                                            <div class="col-md-4 position-relative">
                                                ...
                                                <input class="form-control" name="employee_name" id="employee_name" value="{{ $employee->employee_name }}" type="text"
                                                    placeholder="Employee Name" required="">
                                            </div>
                                            <div class="col-md-4 position-relative">
                                                <label class="form-label" for="employee_id"> Employee ID*
                                                </label>
                                                <input type="text" name="employee_id" id="employee_id" class="form-control" value="{{ $employee->employee_id }}" placeholder="Employee ID">
                                            </div>
                                            <div class="col-md-4 position-relative ">
                                                <label class="form-label" for="username">User Name* </label>
                                                <input type="text" name="username" id="username" class="form-control" value="{{ $employee->username }}" placeholder="User Name">
                                            </div>
                                            <div class="col-md-4 position-relative ">
                                            ...
                                            <div class="col-md-4 position-relative">
                                                ...
                                                <input class="form-control digits" name="employee_email" id="employee_email" value="{{ $employee->employee_email }}" type="email">
                                            </div>
                                            <div class="col-md-4  position-relative">
                                                <label class="form-label" for="employee_mobile">Mobile Number*
                                                </label>
                                                <input type="text" class="form-control" name="employee_mobile" value="{{ $employee->employee_mobile }}" id="employee_mobile"placeholder="0123456789">
                                            </div>
                                            <div class="col-md-4  position-relative">
                                                ...
                                                @if ($employee->employee_adhaar_doc)
                                                    <div>
                                                        <a href="{{ asset($employee->employee_adhaar_doc) }}" target="_blank">{{ $employee->employee_adhaar_doc }}</a>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="col-md-4 position-relative">
                                                <label class="form-label" for="employee_dob"> D.O.B* </label>
                                                <input class="form-control digits" name="employee_dob" id="employee_dob" value="{{ $employee->employee_dob }}" type="date">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row ">
                                            ...
                                            <div class="col-md-12 position-relative"><br>
                                                ...
                                                <textarea class="form-control" name="employee_address" id="employee_address"
                                                    rows="3">{{ $employee->employee_address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 position-relative">
                                        ...
                                        @if ($employee->employee_qualification_doc)
                                            <div>
                                                <a href="{{ asset($employee->employee_qualification_doc) }}" target="_blank">{{ $employee->employee_qualification_doc }}</a>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-xxl-4 col-sm-6">
                                        <label class="form-label" for="employee_experience"> Work Experience* </label>
                                        <input class="form-control" name="employee_experience"  id="employee_experience" type="text" value="{{ $employee->employee_experience }}" required=""
                                    ...
                                    <div class="col-md-4 position-relative">
                                        ...
                                        @if ($employee->employee_resume)
                                            <div>
                                                <a href="{{ asset($employee->employee_resume) }}" target="_blank">{{ $employee->employee_resume }}</a>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-md-4 position-relative">
                                        ...
                                        @if ($employee->employee_passbook_doc)
                                            <div>
                                                <a href="{{ asset($employee->employee_passbook_doc) }}" target="_blank">{{ $employee->employee_passbook_doc }}</a>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-md-4 position-relative">
                                        ...
                                        @if ($employee->employee_pan_doc)
                                            <div>
                                                <a href="{{ asset($employee->employee_pan_doc) }}" target="_blank">{{ $employee->employee_pan_doc }}</a>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-xxl-4 col-sm-6" id="employeeForm">
                                        ...
                                        <select class="form-select" name="employee_type" onchange="toggleFormSection()" id="employee_type"
                                            ...
                                            <option {{ $employee->employee_type == 'SalesExecutive' ? 'selected' : '' }} value="SalesExecutive">Sales Executive</option>
                                            <option {{ $employee->employee_type == 'Packing' ? 'selected' : '' }} value="Packing">Packing</option>
                                            <option {{ $employee->employee_type == 'SalesManager' ? 'selected' : '' }} value="SalesManager">Sales Manager</option>
                                            <option {{ $employee->employee_type == 'Verifier' ? 'selected' : '' }} value="Verifier">Verifier</option>
                                            <option {{ $employee->employee_type == 'Trainer' ? 'selected' : '' }} value="Trainer">Trainer</option>
                                            <option {{ $employee->employee_type == 'Dealer' ? 'selected' : '' }} value="Dealer">Dealer</option>
                                        </select>
                                    </div>
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-section {{ $employee->employee_type == 'SalesExecutive' ? 'show' : '' }}" id="SalesExecutiveSection" >
                                                ...
                                                <h1 class="Sales__Executive">Sales Executive Details</h1><br>
                                                    ...
                                                    <div class="col-md-4 position-relative padding">
                                                        ...
                                                        <select class="form-select one" required="" name="vehichle_type" id="vehichle_type">
                                                            ...
                                                            <option {{ $employee->vehichle_type == 'Bike' ? 'selected' : '' }} value="Bike">Bike</option>
                                                            <option {{ $employee->vehichle_type == 'Car' ? 'selected' : '' }} value="Car">Car</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <input class="form-control" name="vehichle_license" id="vehichle_license" type="file"
                                                            required="">
                                                             @if ($employee->vehichle_license)
                                                                 <div>
                                                                     <a href="{{ asset($employee->vehichle_license) }}" target="_blank">{{ $employee->vehichle_license }}</a>
                                                                 </div>
                                                             @endif
                                                    </div>
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <input class="form-control" name="vehichle_insurance" id="vehichle_insurance" type="file"
                                                            required="">
                                                             @if ($employee->vehichle_insurance)
                                                                 <div>
                                                                     <a href="{{ asset($employee->vehichle_insurance) }}" target="_blank">{{ $employee->vehichle_insurance }}</a>
                                                                 </div>
                                                             @endif
                                                    </div>
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <input class="form-control" name="vehichle_name" id="vehichle_name" type="text"
                                                            required="" placeholder="vehicle Name" value="{{ $employee->employee_type == 'SalesExecutive' ? $employee->vehichle_name : '' }}">
                                                    </div>
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <input class="form-control" name="vehichle_regno" id="vehichle_regno" type="text"
                                                            required="" placeholder="Vehicle registration Number" value="{{ $employee->employee_type == 'SalesExecutive' ? $employee->vehichle_regno : '' }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <select name="employee_zone_country" id="employee_zone_country" class="form-control" required>
                                                            ...
                                                            <option {{ $country->id == $employee->employee_zone_country ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <select name="employee_zone_state" id="employee_zone_state" class="form-control" required>
                                                            ...
                                                            <option {{ $state->id == $employee->employee_zone_state ? 'selected' : '' }} value="{{ $state->id }}">{{ $state->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <select name="employee_zone_city" id="employee_zone_city" class="form-control" required>
                                                            ...
                                                            <option {{ $city->id == $employee->employee_zone_city ? 'selected' : '' }} value="{{ $city->id }}">{{ $city->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        <input class="form-control" name="employee_zone_pincode" id="employee_zone_pincode" type="text"
                                                            required="" value="{{ $employee->employee_zone_pincode }}">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <button class="btn btn-primary" id="edit_employee_btn" type="submit">Submit</button>
                                    </div>
