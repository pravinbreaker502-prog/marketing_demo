                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Trainer Cancel Works</li>
                            ...
                            <div class="card-body">
                                <div class="list-product-header">
                                  <div> 
                                    ...
                                    <button id="trainers_cancelled-refresh-table" class="btn btn-primary"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                                  </div>
                                 
                                </div>
                                <div class="list-product list-category">
                                    <table class="table" id="trainers_cancelled-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                ...
                                                <th> <span class="f-light f-w-600">Reason to Cancel</span></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
