...
Route::post('show-or-hide-quantity', [ProductController::class, 'ShowOrHideQuantity'])->name('show-or-hide-quantity.get');
...
Route::post('get-products-list-for-order', [OrdersController::class, 'getProductsListForOrder'])->name('products-list-for-order.get');
...
Route::post('delete-invoices', [InvoiceController::class, 'deleteInvoices'])->name('invoices.delete');
...
// For Trainers
Route::get('/trainer_pending', [TrainersFollowController::class, 'TrainersPendingIndex']);
Route::get('/trainer_process', [TrainersFollowController::class, 'TrainersProcessIndex']);
Route::get('/trainer_completed', [TrainersFollowController::class, 'TrainersCompletedIndex']);
Route::get('/trainer_cancel_works', [TrainersFollowController::class, 'TrainersCancelledIndex']);
Route::post('get-assign-trainers-by-status', [TrainersFollowController::class, 'getAssignTrainersByStatus'])->name('assign-trainers-by-status.get');
Route::post('update-status-of-trainee-works', [TrainersFollowController::class, 'updateStatusOfTrainersWorks'])->name('status-of-trainee-works.update');
Route::post('update-status-and-reason', [TrainersFollowController::class, 'RejectAndUpdateReason'])->name('status-and-reason.update');
Route::post('complete-status-and-noteachers', [TrainersFollowController::class, 'CompleteAndUpdateNoOfTeachers'])->name('complete-status-and-noteachers.update');

Route::get('/leave-requests', [LeaveRequestsController::class, 'index']);
Route::post('get-leave-requests', [LeaveRequestsController::class, 'getLeaveRequests'])->name('leave-requests.get');
Route::post('accept-leave-requests', [LeaveRequestsController::class, 'acceptLeaveRequest'])->name('leave-requests.accept');
Route::post('reject-leave-requests', [LeaveRequestsController::class, 'rejectLeaveRequest'])->name('leave-requests.reject');

Route::get('/products-qty', function () {
    $datas['headerlinks'] = HeaderLinks();
    $datas['scriptlinks'] = ScriptLinks();
    $datas['headermenu'] = HeaderMenu();
    $datas['sidemenubar'] = SideMenuBars();
    return view('marketing.products-qty.products-qty', compact('datas'));
});

Route::get('/add-products-qty', function () {
    $datas['headerlinks'] = HeaderLinks();
    $datas['scriptlinks'] = ScriptLinks();
    $datas['headermenu'] = HeaderMenu();
    $datas['sidemenubar'] = SideMenuBars();
    return view('marketing.products-qty.add-products-qty', compact('datas'));
});

Route::get('/edit-products-qty', function () {
    $datas['headerlinks'] = HeaderLinks();
    $datas['scriptlinks'] = ScriptLinks();
    $datas['headermenu'] = HeaderMenu();
    $datas['sidemenubar'] = SideMenuBars();
    return view('marketing.products-qty.edit-products-qty', compact('datas'));
});
